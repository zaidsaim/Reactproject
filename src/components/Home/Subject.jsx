...
import math from '../../assets/img/submath.jpg'
...
import subotherimg from '../../assets/img/subotherimg.jpg'
    ...
    return (
        ...
        <div class="container">
            <div class="row g-0 mx-lg-0">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-4">
                                        <p class="text-white mb-2">Services</p>
                ...
                <div class="col-lg-6 pe-lg-0 wow fadeIn" data-wow-delay="0.5s"  style={{ maxHeight: '400px' }}>
                    <div class="position-relative h-100">
                        <img class="position-absolute img-fluid w-100 h-100" src={Feature}
